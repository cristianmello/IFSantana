...
class Funcion4 {
	...
	public void entradaProduto(int id, int cantidad) throws SQLException {
		...
		try {
			PreparedStatement update = (PreparedStatement) conexao.prepareStatement(
					"update produtos set Quantidade = Quantidade + '" + cantidad + "'" + "where Id = '" + id + "' ;");
